...
<html lang="en">
  <head>
    ...
    <link href="../res/nprogress/nprogress.css" rel="stylesheet">
    <link href="../res/iCheck/skins/flat/green.css" rel="stylesheet">
    <link href="../res/google-code-prettify/bin/prettify.min.css" rel="stylesheet">
    <link href="../res/select2/dist/css/select2.min.css" rel="stylesheet">
    <link href="../res/switchery/dist/switchery.min.css" rel="stylesheet">
    <link href="../res/starrr/dist/starrr.css" rel="stylesheet">
    <link href="../res/build/css/custom.min.css" rel="stylesheet">
<!--    <style type="text/css">
    	#formularios{ min-height:400px;}
    </style>
-->  </head>
  <body class="nav-md">
